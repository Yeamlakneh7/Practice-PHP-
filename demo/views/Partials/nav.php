        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="http://localhost/phpProject/demo/index.php" class="<?= urlIs('/phpProject/demo/index.php') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700' ?> rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Home</a>
